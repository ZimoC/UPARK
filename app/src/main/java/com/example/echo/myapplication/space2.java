...
public class space2 extends Activity implements OnClickListener {
    ...
    public void onClick(View v) throws SecurityException {
        switch (v.getId()){
            ...
            case R.id.dial:
                Uri uri2 = Uri.parse("tel:6179824253");
            ...
            case R.id.map:
                Uri uri3 = Uri.parse("geo:0,0?q=1-99 Cedar Hill Ln, Waltham, MA02452");
